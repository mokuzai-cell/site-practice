<template>
    <div class="bc_all">
        <div class="bc_top">
                <img id="bc_img" :inferSize="isinfersize" :src="img" :alt="title" loading="lazy" />
